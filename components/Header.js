      ...
      <div className="flex flex-1 items-center justify-between px-[36px] group-hover:text-black">
          ...
          <Link href="/">
            <svg
              ...
              className={classNames(
                "h-[23px] w-full fill-white group-hover:fill-black transition-all duration-[.3s] ease-in-out"
              )}
            >
              <path
        ...
        <div className="flex items-center gap-[30px]">
          ...
          <button className="flex items-start">
            ...
            <span className="h-3 w-3 border bg-transparent flex items-center justify-center text-[8px] leading-3 relative top-[-2px] group-hover:text-black group-hover:border-black rounded-full">
              0
            </span>
          </button>
        </div>
